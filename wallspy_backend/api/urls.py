...
from .views import MarketActionViewSet, export_market_offers, export_activity, export_activity_stats, get_last_actions, \
    export_month_transactions, export_tx_top, export_users_top, export_users_stats, export_crypto_pairs


api_version = 'v1'

router = DefaultRouter()
# router.register('pairs', PairsViewSet, basename='pairs')
...
urlpatterns = [
    ...
    path(f'{api_version}/market/pairs/', export_crypto_pairs),
